...
idCVar pm_thirdPersonXOff(			"pm_thirdPersonXOff",		"8.0",			CVAR_GAME | CVAR_NETWORKSYNC | CVAR_FLOAT, "Camera x offset from normal view in 3rd person");
...
idCVar g_showProjectilePct(			"g_showProjectilePct",		"0",			CVAR_GAME | CVAR_ARCHIVE | CVAR_BOOL, "enables display of player hit percentage" ); //GK: Unused
...
idCVar cl_close("cl_close", "0", CVAR_GAME | CVAR_BOOL, "");
