...
bool idMat4::InverseFastSelf()
{
	...
	r0[0][0] =   mat_[1 * 4 + 1] * invDet;
	r0[0][1] = - mat_[0 * 4 + 1] * invDet;
	r0[1][0] = - mat_[1 * 4 + 0] * invDet;
	r0[1][1] =   mat_[0 * 4 + 0] * invDet;
	
	// r1 = r0 * m1;
	r1[0][0] = r0[0][0] * mat_[0 * 4 + 2] + r0[0][1] * mat_[1 * 4 + 2];
	r1[0][1] = r0[0][0] * mat_[0 * 4 + 3] + r0[0][1] * mat_[1 * 4 + 3];
	r1[1][0] = r0[1][0] * mat_[0 * 4 + 2] + r0[1][1] * mat_[1 * 4 + 2];
	r1[1][1] = r0[1][0] * mat_[0 * 4 + 3] + r0[1][1] * mat_[1 * 4 + 3];
	
	// r2 = m2 * r1;
	r2[0][0] = mat_[2 * 4 + 0] * r1[0][0] + mat_[2 * 4 + 1] * r1[1][0];
	r2[0][1] = mat_[2 * 4 + 0] * r1[0][1] + mat_[2 * 4 + 1] * r1[1][1];
	r2[1][0] = mat_[3 * 4 + 0] * r1[0][0] + mat_[3 * 4 + 1] * r1[1][0];
	r2[1][1] = mat_[3 * 4 + 0] * r1[0][1] + mat_[3 * 4 + 1] * r1[1][1];
	
	// r3 = r2 - m3;
	r3[0][0] = r2[0][0] - mat_[2 * 4 + 2];
	r3[0][1] = r2[0][1] - mat_[2 * 4 + 3];
	r3[1][0] = r2[1][0] - mat_[3 * 4 + 2];
	r3[1][1] = r2[1][1] - mat_[3 * 4 + 3];
	...
	// r2 = m2 * r0;
	r2[0][0] = mat_[2 * 4 + 0] * r0[0][0] + mat_[2 * 4 + 1] * r0[1][0];
	r2[0][1] = mat_[2 * 4 + 0] * r0[0][1] + mat_[2 * 4 + 1] * r0[1][1];
	r2[1][0] = mat_[3 * 4 + 0] * r0[0][0] + mat_[3 * 4 + 1] * r0[1][0];
	r2[1][1] = mat_[3 * 4 + 0] * r0[0][1] + mat_[3 * 4 + 1] * r0[1][1];
	
	// m2 = r3 * r2;
	mat_[2 * 4 + 0] = r3[0][0] * r2[0][0] + r3[0][1] * r2[1][0];
	mat_[2 * 4 + 1] = r3[0][0] * r2[0][1] + r3[0][1] * r2[1][1];
	mat_[3 * 4 + 0] = r3[1][0] * r2[0][0] + r3[1][1] * r2[1][0];
	mat_[3 * 4 + 1] = r3[1][0] * r2[0][1] + r3[1][1] * r2[1][1];
	
	// m0 = r0 - r1 * m2;
	mat_[0 * 4 + 0] = r0[0][0] - r1[0][0] * mat_[2 * 4 + 0] - r1[0][1] * mat_[3 * 4 + 0];
	mat_[0 * 4 + 1] = r0[0][1] - r1[0][0] * mat_[2 * 4 + 1] - r1[0][1] * mat_[3 * 4 + 1];
	mat_[1 * 4 + 0] = r0[1][0] - r1[1][0] * mat_[2 * 4 + 0] - r1[1][1] * mat_[3 * 4 + 0];
	mat_[1 * 4 + 1] = r0[1][1] - r1[1][0] * mat_[2 * 4 + 1] - r1[1][1] * mat_[3 * 4 + 1];
	
	// m1 = r1 * r3;
	mat_[0 * 4 + 2] = r1[0][0] * r3[0][0] + r1[0][1] * r3[1][0];
	mat_[0 * 4 + 3] = r1[0][0] * r3[0][1] + r1[0][1] * r3[1][1];
	mat_[1 * 4 + 2] = r1[1][0] * r3[0][0] + r1[1][1] * r3[1][0];
	mat_[1 * 4 + 3] = r1[1][0] * r3[0][1] + r1[1][1] * r3[1][1];
