...
@ECHO			   VS 2012 PROJECT GENERATION FOR x86 - x64
@ECHO --------------------------------------------------------------------------------
cd ..
...
cmake -G "Visual Studio 11 Win64" -DCMAKE_INSTALL_PREFIX=../bin/win8-64 ../neo > NUL 2>&1
...
cmake -G "Visual Studio 11" -DCMAKE_INSTALL_PREFIX=../bin/win8-32 ../neo > NUL 2>&1
