...
cmake -G "Visual Studio 14 Win64" -T v140_xp -DCMAKE_INSTALL_PREFIX=../bin/windows10-64 -DWINDOWS10=ON ../neo > NUL 2>&1
...
cmake -G "Visual Studio 14" -T v140_xp -DCMAKE_INSTALL_PREFIX=../bin/windows10-32 -DWINDOWS10=ON ../neo > NUL 2>&1
