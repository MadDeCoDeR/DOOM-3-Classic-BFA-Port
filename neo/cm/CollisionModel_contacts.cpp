...
==================
*/
int idCollisionModelManagerLocal::Contacts( contactInfo_t* _contacts, const int _maxContacts, const idVec3& start, const idVec6& dir, const float depth,
		...
		cmHandle_t model, const idVec3& origin, const idMat3& modelAxis )
{
	...
	idCollisionModelManagerLocal::contacts = _contacts;
	idCollisionModelManagerLocal::maxContacts = _maxContacts;
