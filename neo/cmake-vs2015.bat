...
cmake -G "Visual Studio 14 Win64" -DCMAKE_INSTALL_PREFIX=../bin/windows7-64 ../neo > NUL 2>&1
...
cmake -G "Visual Studio 14" -DCMAKE_INSTALL_PREFIX=../bin/windows7-32 -DWINDOWS10=OFF ../neo > NUL 2>&1
